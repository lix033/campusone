...
import { Badge, Button, Card, CardHeader, Dialog, Field, Select, Tabs, Textarea, cn, useToast } from "@/components/ui";
import { bordereaux, formatFCFA, recentPayments } from "@/lib/mocks";
              ...
              {queue.map((b) => (
                <li key={b.id} className="flex flex-col gap-3 px-5 py-4 md:flex-row md:items-center">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="font-semibold text-navy-900">{b.candidate} <Link href={`/admin/dossiers/${b.dossier}`} className="ml-1 font-mono text-xs font-normal text-brand-600 hover:underline">{b.dossier}</Link></p>
