...
import { Badge, Button, Card, CardHeader, Progress, cn, useToast } from "@campus-one/ui";
import { bank, contact, formatFCFA, myPayments, paymentStatusLabel, type Payment } from "@campus-one/mocks";
