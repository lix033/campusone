...
import { Avatar, Badge, Card, CardHeader, Progress, Timeline, buttonClasses } from "@campus-one/ui";
import { FirstName } from "@/components/espace/first-name";
import { formatFCFA, me, myApplications, myAppointments, myDocuments, myMessages, myPayments } from "@campus-one/mocks";
