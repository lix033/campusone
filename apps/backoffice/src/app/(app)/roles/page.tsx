...
import { Avatar, Badge, Button, Card, CardHeader, Dialog, Field, Input, Select, Tabs, Textarea, cn, useToast } from "@campus-one/ui";
import { agents, permissionGroups, roles } from "@campus-one/mocks";
