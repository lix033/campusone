...
import { Badge, Button, Card, Drawer, Field, Input, Select, Textarea, useToast } from "@campus-one/ui";
import { etablissements, formations, levels, schoolOf, type Formation } from "@campus-one/mocks";
